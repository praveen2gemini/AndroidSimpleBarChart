...
//    private static final int DEFAULT_Y_AXIS_EXTRA = 15;
    private static final int DEFAULT_Y_AXIS_EXTRA = 0;
    /**
    ...
    protected void drawForm(
        ...
        switch (form) {
            ...
            case CIRCLE:
                mLegendFormPaint.setStyle(Paint.Style.FILL);
                c.drawCircle(x + half, (y+ DEFAULT_Y_AXIS_EXTRA), half, mLegendFormPaint);
                break;
    ...
    protected void drawLabel(Canvas c, float x, float y, String label) {
        c.drawText(label, x, (y + DEFAULT_Y_AXIS_EXTRA), mLegendLabelPaint);
    }
}
